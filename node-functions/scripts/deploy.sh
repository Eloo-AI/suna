...
deploy_function "eloo-agent-sandbox-delete" "eloo-agent-sandbox-delete" "60s" "Stop agent and delete sandbox"
...
echo "   Sandbox Delete: https://$REGION-$PROJECT_ID.cloudfunctions.net/eloo-agent-sandbox-delete"
...
echo ""
echo "🎉 Deployment complete! All 18 active functions deployed."