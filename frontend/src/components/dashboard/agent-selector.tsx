...
export function AgentSelector({ 
  ...
  const displayName = currentAgent?.name || defaultAgent?.name || 'Eloo AI';
  const agentAvatar = currentAgent?.avatar;
  const isUsingElooAI = !currentAgent && !defaultAgent;
              ...
              >
                <div className="flex items-center gap-2 w-full">
                  ...
                  <div className="flex items-center gap-1 flex-1 min-w-0">
                    <span className="font-medium truncate">Eloo AI</span>
            ...
            >
              <div className="flex items-center gap-2 w-full">
                ...
                <div className="flex items-center gap-1 flex-1">
                  <span className="font-medium">Eloo AI</span>
                  <Badge variant="outline" className="text-xs px-1 py-0">
                    Default
                  </Badge>
                </div>
