...
export const metadata: Metadata = {
  ...
  description:
    'Eloo AI is a fully open source AI assistant that helps you accomplish real-world tasks with ease. Through natural conversation, Eloo AI becomes your digital companion for research, data analysis, and everyday challenges.',
  keywords: [
    'AI',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Eloo AI - Open Source Generalist AI Agent',
        type: 'image/png',
      },
    ],
    locale: 'en_US',
