                ...
                {activeTab === 'terms' ? (
                  <div>
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      ...
                      CAREFULLY BEFORE USING THE SERVICES OFFERED BY Eloo AI
                    ...
                    <ul className="text-muted-foreground space-y-1 mb-6">
                      <li>
                        "Company" refers to Eloo AI Corp (701 Tillery Street
                      ...
                      <li>
                        ...
                        Company, specifically legal@eloo.ai
                      </li>
                      <li>
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      Eloo AI is licensed under the Apache License, Version 2.0.
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      ...
                      please write to legal@eloo.ai and we will process and
                    ...
                    <p className="text-muted-foreground text-balance mb-4">
                      ...
                      or by emailing us at legal@eloo.ai. If you cancel
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      All Eloo AI logos, marks, and designations are trademarks or
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      ...
                      LIMITATION, THE ELOO AI WEB APP AND ANY CONTENT) IS PROVIDED
                      ...
                      ELOO AI DOES NOT GUARANTEE THE ACCURACY, COMPLETENESS, OR
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      References to our "Services" at Eloo AI in this statement
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      Eloo AI does not collect biometric or identifying
