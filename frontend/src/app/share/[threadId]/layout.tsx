...
export async function generateMetadata({ params }): Promise<Metadata> {
  ...
  const fallbackMetaData = {
    title: 'Shared Conversation | Eloo AI',
    description: 'Replay this Agent conversation on Eloo AI',
    alternates: {
  ...
  try {
    ...
    const title = projectData.name || 'Shared Conversation | Eloo AI';
    const description =
      projectData.description ||
              'Replay this Agent conversation on Eloo AI';
